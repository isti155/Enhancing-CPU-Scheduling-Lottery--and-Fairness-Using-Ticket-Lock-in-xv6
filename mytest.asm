...
{ 
  ...
  18:	e8 b3 03 00 00       	call   3d0 <printf>
    exit();
  1d:	e8 51 02 00 00       	call   273 <exit>
  22:	66 90                	xchg   %ax,%ax
  24:	66 90                	xchg   %ax,%ax
  26:	66 90                	xchg   %ax,%ax
  28:	66 90                	xchg   %ax,%ax
 ...
 338:	89 d1                	mov    %edx,%ecx
{
 ...
 36b:	0f b6 92 50 07 00 00 	movzbl 0x750(%edx),%edx
 ...
 3d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 444:	ff 24 85 f8 06 00 00 	jmp    *0x6f8(,%eax,4)
 ...
 550:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 555:	bb ee 06 00 00       	mov    $0x6ee,%ebx
 ...
 561:	a1 ec 09 00 00       	mov    0x9ec,%eax
{
 ...
 59f:	5b                   	pop    %ebx
  freep = p;
 5a0:	a3 ec 09 00 00       	mov    %eax,0x9ec
}
 5a5:	5e                   	pop    %esi
 5a6:	5f                   	pop    %edi
 5a7:	5d                   	pop    %ebp
 ...
 5b6:	72 ce                	jb     586 <free+0x26>
{
 ...
 5d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5da:	a3 ec 09 00 00       	mov    %eax,0x9ec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 15 ec 09 00 00    	mov    0x9ec,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 63b:	3b 05 ec 09 00 00    	cmp    0x9ec,%eax
 ...
 65e:	e8 fd fe ff ff       	call   560 <free>
  return freep;
 663:	8b 15 ec 09 00 00    	mov    0x9ec,%edx
 ...
 68c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 68f:	89 15 ec 09 00 00    	mov    %edx,0x9ec
}
 ...
 69f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6a0:	c7 05 ec 09 00 00 f0 	movl   $0x9f0,0x9ec
 6a7:	09 00 00 
    base.s.size = 0;
 6aa:	b8 f0 09 00 00       	mov    $0x9f0,%eax
    base.s.ptr = freep = prevp = &base;
 6af:	c7 05 f0 09 00 00 f0 	movl   $0x9f0,0x9f0
 6b6:	09 00 00 
    base.s.size = 0;
 6b9:	c7 05 f4 09 00 00 00 	movl   $0x0,0x9f4
 6c0:	00 00 00 
    if(p->s.size >= nunits){
